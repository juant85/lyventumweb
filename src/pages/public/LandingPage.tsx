        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col items-center gap-12 lg:gap-16 pt-8">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="text-base md:text-lg px-8 py-4 shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 transition-all flex items-center justify-center font-bold rounded-full"
                >
          ...
          >
            <div className="relative aspect-video rounded-[2rem] overflow-hidden border border-slate-800 shadow-2xl shadow-slate-950/50 bg-slate-900/50 backdrop-blur-sm">
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-slate-900/90 backdrop-blur-md p-4 rounded-full border border-slate-800/50 flex items-center gap-6 shadow-xl max-w-[90%] w-auto">
                ...
                <div className="pr-2">
                  <p className="text-white font-bold text-sm whitespace-nowrap">{t(localeKeys.trustedByProfessionals)}</p>
                </div>
              </div>
            </div>
          </motion.div>
