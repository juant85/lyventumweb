  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden"
      ...
      <section
        ...
        className="relative min-h-[100vh] md:min-h-[90vh] flex items-center pt-44 md:pt-60 pb-12 px-5 sm:px-6 md:px-8 overflow-hidden safe-area-top safe-area-bottom"
      >
