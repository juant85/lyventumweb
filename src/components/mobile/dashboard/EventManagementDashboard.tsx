...
const EventManagementDashboard: React.FC = () => {
    ...
    const sessionsTrend = generateMetricTrendData(eventStats.sessions, 10);
    const boothsTrend = generateMetricTrendData(eventStats.booths, 5);
    const attendeesTrend = generateMetricTrendData(eventStats.attendees, 20);
    const scansTrend = generateMetricTrendData(eventStats.scans, 30);
    const checkedInTrend = generateMetricTrendData(eventStats.checkedIn, 18);
                ...
                <MobileContentContainer className="mb-6">
                    ...
                    <SwipeableCarousel>
                        <QuickStatCard
                            ...
                            sparklineData={sessionsTrend.sparklineData}
                            trendDirection={sessionsTrend.trendDirection}
                        />
                        <QuickStatCard
                            label="Booths"
                            value={eventStats.booths}
                            icon="store"
                            color="purple"
                            trend={boothsTrend.trend}
                            sparklineData={boothsTrend.sparklineData}
                            trendDirection={boothsTrend.trendDirection}
                        />
                        <QuickStatCard
                            label="Attendees"
                            value={eventStats.attendees}
                            icon="users"
                            color="green"
                            trend={attendeesTrend.trend}
                            sparklineData={attendeesTrend.sparklineData}
                            trendDirection={attendeesTrend.trendDirection}
                        />
                        <QuickStatCard
                            label="Scans"
                            value={eventStats.scans}
                            icon="checkCircle"
                            color="amber"
                            trend={scansTrend.trend}
                            sparklineData={scansTrend.sparklineData}
                            trendDirection={scansTrend.trendDirection}
                        />
                        <QuickStatCard
                            label="Checked In"
                            value={eventStats.checkedIn}
                            icon="checkCircle"
                            color="pink"
